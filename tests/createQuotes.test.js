...
beforeAll(async () => {
    const createUserResponse = await request(app)
        ...
        .send({
            name: 'Test User',
            email: 'createQuote1@example.com',
            password: 'password',
    ...
    await request(app)
        ...
        .send({
            name: 'Test User',
            email: 'createQuote2@example.com',
            password: 'password',
            confirmPassword: 'password'
        });
...
describe("test the different types to create quotes", () => {
    ...
    it('Trys to create a quote where another user is the author', async () => {
